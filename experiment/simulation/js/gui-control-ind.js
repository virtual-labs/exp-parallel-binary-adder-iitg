...
$(document).ready(function() {
    ...
    circuitController.addEndPoint('ic_7432_comp','ic_7432_comp_PIN4_1','r10','vcc_grp','input','output',1,[0,1,0,1,47,11]);
    circuitController.addEndPoint('ic_7432_comp','ic_7432_comp_PIN4_2','r10','vcc_grp','input','output',1,[0,1,0,1,47,25]);
    circuitController.addEndPoint('ic_7432_comp','ic_7432_comp_PIN4_3','r10','vcc_grp','input','output',1,[0,1,0,1,47,38]);
    circuitController.addEndPoint('ic_7432_comp','ic_7432_comp_PIN4_4','r10','vcc_grp','input','output',1,[0,1,0,1,47,51]);
    ...
    circuitController.addEndPoint('ic_7432_comp','ic_7432_comp_PIN7_1','GND','ic_7432_comp_gr2','output','input',1,[0,1,0,1,88,11]);
    circuitController.addEndPoint('ic_7432_comp','ic_7432_comp_PIN7_2','GND','ic_7432_comp_gr2','output','input',1,[0,1,0,1,88,25]);
    circuitController.addEndPoint('ic_7432_comp','ic_7432_comp_PIN7_3','GND','ic_7432_comp_gr2','output','input',1,[0,1,0,1,88,38]);
    circuitController.addEndPoint('ic_7432_comp','ic_7432_comp_PIN7_4','GND','ic_7432_comp_gr2','output','input',1,[0,1,0,1,88,51]);

    circuitController.addEndPoint('ic_7432_comp','ic_7432_comp_PIN14_1','VCC','ic_7432_comp_gr2','input','output',1,[0,0,0,-1,8,-11]);
    circuitController.addEndPoint('ic_7432_comp','ic_7432_comp_PIN14_2','VCC','ic_7432_comp_gr2','input','output',1,[0,0,0,-1,8,-25]);
    circuitController.addEndPoint('ic_7432_comp','ic_7432_comp_PIN14_3','VCC','ic_7432_comp_gr2','input','output',1,[0,0,0,-1,8,-38]);
    circuitController.addEndPoint('ic_7432_comp','ic_7432_comp_PIN14_4','VCC','ic_7432_comp_gr2','input','output',1,[0,0,0,-1,8,-51]);
    ...
    circuitController.addEndPoint('ic_7432_comp','ic_7432_comp_PIN11_1','c10','ic_7432_comp_gr3','output','input',-1,[0,0,0,-1,47,-11]);
    circuitController.addEndPoint('ic_7432_comp','ic_7432_comp_PIN11_2','c10','ic_7432_comp_gr3','output','input',-1,[0,0,0,-1,47,-25]);
    circuitController.addEndPoint('ic_7432_comp','ic_7432_comp_PIN11_3','c10','ic_7432_comp_gr3','output','input',-1,[0,0,0,-1,47,-38]);
    circuitController.addEndPoint('ic_7432_comp','ic_7432_comp_PIN11_4','c10','ic_7432_comp_gr3','output','input',-1,[0,0,0,-1,47,-51]);
	...
	//----------------------------------------------Latest modified------------------------------------------------------------------->
	circuitController.addEndPoint('output_cout_comp','output_cout_comp_PIN_Cout2','c17','output_cout_comp_gr','input','output',1,[0.5,1,0,1,0,-3], true);
